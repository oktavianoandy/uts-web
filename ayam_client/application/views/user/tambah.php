        ...
        <div class="card-body card-block">
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="row form-group">
                    ...
                    <?php else : ?>
                        <div class="col-12 col-md-9"><input type="text" id="username" name="username" placeholder="Masukkan username" class="form-control" value="<?= $pegawai[0]->nama; ?>">
                ...
                <div class="row form-group">
                    ...
                    <?php else : ?>
                        <div class="col-12 col-md-9"><input type="password" id="password" name="password" placeholder="Masukkan password" class="form-control" value="<?= $password?>">
                            <small class=" form-text text-danger"> </small>
                        </div>
                    <?php endif ?>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <?php else : ?>
                        <div class="col-12 col-md-9"><input type="password" id="confirm_password" name="confirm_password" placeholder="Masukkan lagi password" class="form-control" value="<?= $password?>">
                            <small class=" form-text text-danger"> </small>
                        </div>
                    <?php endif ?>
                </div>
