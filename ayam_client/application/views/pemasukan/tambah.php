<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <strong> Tambah Data Pemasukan </strong>
        </div>
        <div class="card-body card-block">
            <form action="<?= base_url() ?>pemasukan/tambahPemasukan" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="row form-group">
                    ...
                    <?php else : ?>
                        <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" placeholder="Masukkan nama pemasukan" class="form-control">
                ...
                <?php else : ?>
                    <div class="row form-group">
                        <div class="col col-md-2"><label for="keterangan" class=" form-control-label">Keterangan</label></div>
                        <div class="col-12 col-md-9"><textarea name="keterangan" id="keterangan" rows="3" placeholder="Masukkan keterangan pemasukan" class="form-control"></textarea>
                ...
                <div class="row form-group">
                    ...
                    <?php else : ?>
                        <div class="col-12 col-md-9"><input type="text" id="harga" name="harga" placeholder="Masukkan besar pemasukan (angka)" class="form-control">
                            <small class="form-text text-danger"> </small>
                        </div>
                    <?php endif ?>
                </div>
